...
Further typical voltage levels which can be used in the simulation and the configuration of individual reference systems are described in the documentation of {doc}`reference system <https://github.com/ie3-institute/simona/blob/da5ec110b8c52536e7e6db093e5e32b028649e19/docs/readthedocs/models/reference_system.md>`.
