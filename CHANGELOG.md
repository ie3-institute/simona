...
- Fixed domestic hot water demand handling for cases where the storage does not contain enough energy [#1767](https://github.com/ie3-institute/simona/issues/1767)
...
- Removed `greclipse()`from spotless task for groovyGradle to resolve long CI-Pipeline runs [#1803](https://github.com/ie3-institute/simona/issues/1803)
