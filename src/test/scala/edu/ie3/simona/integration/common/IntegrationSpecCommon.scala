...
trait IntegrationSpecCommon {
  ...
  /* ATTENTION: Do not change this file to a path within "inputData". If you come to this point because the CI
   ...
   * parameters from via include <path-to-config> (e.g. include "inputData/vn_simona/vn_simona.conf") at the
   * beginning of your config file and then just override the parameters you want to change! */
  val configFile: String = "inputData/vn_simona/vn_simona.conf"
