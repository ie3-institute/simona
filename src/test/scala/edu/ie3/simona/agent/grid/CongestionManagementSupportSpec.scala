...
class CongestionManagementSupportSpec
  ...
  "CongestionManagementSupport" should {
    ...
    "calculate the voltage range for a lowest grid correctly" in {
      ...
      range.deltaPlus should equalWithTolerance(0.05.asPu, voltageTolerance)
      range.deltaMinus should equalWithTolerance((-0.03).asPu, voltageTolerance)
      range.suggestion should equalWithTolerance(0.02.asPu, voltageTolerance)
    }
  ...
  "A VoltageRange" should {
    ...
    "with inferior voltage ranges" in {
