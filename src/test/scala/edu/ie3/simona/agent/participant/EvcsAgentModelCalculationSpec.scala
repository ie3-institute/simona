...
import squants.Each
import squants.energy.{KilowattHours, Kilowatts, Megawatts, WattHours}
...
class EvcsAgentModelCalculationSpec
  ...
  private implicit val energyTolerance: squants.Energy = WattHours(
    1
  ) // Equality on the basis of 1 Wh
