...
class ExtEmBaseIT
  ...
  "An ExtEmDataService in base mode" should {
    ...
    "work correctly when requesting flex options" in {
      ...
      val setPoints0 = Map(emSupUuid -> new EmSetPoint(emSupUuid, emSupUuid))

      connection.sendSetPoints(0L, setPoints0.asJava, Optional.of(900L))
      ...
      connection.sendSetPoints(900L, setPoints900.asJava, Optional.of(1800L))
    ...
    "work correctly when requesting disaggregated flex options" in {
      ...
      // we return a new set point
      val setPoints1800 = Map(emSupUuid -> new EmSetPoint(emSupUuid, emSupUuid))

      connection.sendSetPoints(1800L, setPoints1800.asJava, Optional.of(2700L))
      ...
      connection.sendSetPoints(2700L, setPoints2700.asJava, Optional.of(3600L))
    ...
    "work correctly without requesting flex options" in {
      ...
      connection.sendSetPoints(3600L, setPoints3600.asJava, Optional.of(4500L))
      ...
      connection.sendSetPoints(4500L, setPoints4500.asJava, Optional.of(5400L))
