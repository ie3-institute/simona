...
class ExtEvDataServiceSpec
  ...
  "An uninitialized ev movement service" must {
    ...
    "stash registration request and handle it correctly once initialized" in {
      ...
      evService ! RegisterForEvDataMessage(evcs1.ref.toClassic, evcs1UUID)
  ...
  "An idle ev movements service" must {
    ...
    "handle duplicate registrations correctly" in {
      ...
      val evcs1 = TestProbe[ServiceMessageUniversal]("evcs1")
      val evcs2 = TestProbe[ServiceMessageUniversal]("evcs2")

      evService ! RegisterForEvDataMessage(evcs1.ref.toClassic, evcs1UUID)
      evcs1.expectNoMessage()

      evService ! RegisterForEvDataMessage(evcs2.ref.toClassic, evcs2UUID)
    ...
    "handle ev arrivals correctly and forward them to the correct evcs" in {
      ...
      val evcs1 = TestProbe[EvMessage]("evcs1")
      val evcs2 = TestProbe[EvMessage]("evcs2")
      ...
      val evsMessage1 = evcs1.expectMessageType[ProvideEvDataMessage]
      evsMessage1.tick shouldBe tick
      evsMessage1.data shouldBe ArrivingEvs(
        Seq(EvModelWrapper(evA))
      )

      val evsMessage2 = evcs2.expectMessageType[ProvideEvDataMessage]
