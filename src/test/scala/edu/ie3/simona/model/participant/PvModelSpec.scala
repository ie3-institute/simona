  ...
  "A PV Model" should {
    ...
    "calculate the day angle J correctly" in {
      val testCases = Table(
        ...
        (
          "2016-10-31T12:15:00+01:00[Europe/Berlin]",
          5.23311872159614873d,
        ), // leap year => day = 305
        (
          "2017-10-31T12:15:00+01:00[Europe/Berlin]",
          5.21590451527510877d,
        ), // regular year => day = 304
        (
          "2011-06-21T13:00:00+02:00[Europe/Berlin]",
          2.9436292808978335d,
        ), // regular year => day = 172
        (
          "2011-04-05T16:00:00+02:00[Europe/Berlin]",
          1.6181353941777565d,
        ), // regular year => day = 95
        (
          "2011-09-21T00:00:00+02:00[Europe/Berlin]",
          4.5273362624335105d,
        ), // regular year => day = 264
        (
          "2011-03-21T00:00:00+01:00[Europe/Berlin]",
          1.359922299362157d,
        ), // regular year => day = 80
      )
    ...
    "calculate the hour angle omega correctly" in {
      val testCases = Table(
        ...
        (
          "2019-01-01T05:00:00+01:00[Europe/Berlin]",
          0d,
          0.16d,
          -1.9465030168609223d,
        ), // long: ~9.17°E
        (
          "2019-01-01T10:05:00+01:00[Europe/Berlin]",
          0d,
          0.16d,
          -0.6156894622152458d,
        ), // different time: 10:05
        (
          "2019-01-01T12:00:00+01:00[Europe/Berlin]",
          0d,
          0.16d,
          -0.11390730226687622d,
        ), // 12:00
        (
          "2019-01-01T14:00:00+01:00[Europe/Berlin]",
          0d,
          0.16d,
          0.40969147333142264d,
        ), // 14:00
        (
          "2019-01-01T17:30:00+01:00[Europe/Berlin]",
          0d,
          0.16d,
          1.3259893306284447d,
        ), // 17:30
        (
          "2019-03-21T05:00:00+01:00[Europe/Berlin]",
          1.359922299362157d,
          0.16d,
          -1.9677750757840207d,
        ...
        (
          "2011-06-21T11:00:00+02:00[Europe/Berlin]",
          2.9436292808978d,
          0.2337d,
          -0.2960273936975511d,
        ), // long of Berlin (13.39E)
        (
          "2011-06-21T12:00:00+02:00[Europe/Berlin]",
          2.9436292808978d,
          0.2337d,
        ...
        (
          "2011-06-21T14:00:00+02:00[Europe/Berlin]",
          2.9436292808978d,
          0.2337d,
          0.4893707696998972d,
        ), // long of Berlin (13.39E)
        (
          "2011-06-21T15:00:00+02:00[Europe/Berlin]",
          2.9436292808978d,
          0.2337d,
          0.7511701574990467d,
        ), // long of Berlin (13.39E)
