...
/** Run a standalone simulation of simona multiple times. Define the amount of
  * runs with the program argument "--repetitions=x"
  *
  * @version 0.1
  * @since 05.09.21
  */
object RunSimonaRepeatedly extends RunSimona[SimonaStandaloneSetup] {
  ...
  override def setup(
    ...
    // Get the targeted amount of runs
    val amountOfRuns = arguments.repetitions
