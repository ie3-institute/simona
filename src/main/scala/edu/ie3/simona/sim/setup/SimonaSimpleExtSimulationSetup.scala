...
class SimonaSimpleExtSimulationSetup(
  ...
  def simpleExtSimulationWithEm(
    ...
    val extEmData = new ExtEmData(
      extEmDataService,
      extSimAdapterPhase1,
      simpleExtSim.getExtEmDataSimulation.getEmDataFactory,
      simpleExtSim.getExtEmDataSimulation.getControlledEms
    )

    simpleExtSim.getExtEmDataSimulation.setExtEmData(extEmData)
    ...
    val extResultData =
      new ExtResultData(
        ...
        simpleExtSim.getExtResultDataSimulation.getGridResultDataAssets,
        simpleExtSim.getExtResultDataSimulation.getParticipantResultDataAssets,
        simulationStart,
        powerFlowResolution
      )
